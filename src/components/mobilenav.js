...
export default function MobileNav({ ...props }) {
  return (
    <nav style={{ position: 'fixed', width: '100vw', height: '100%', backgroundColor: 'black', zIndex: '100',  alignItems: 'center', display: props.state ? 'flex' : 'none', flexDirection: 'column', justifyContent: 'center', top: '0px' }}>
      <div>
        ...
        <div>
          <h3 className="text-primary-content text-xl font-bold mb-4">Connect with us</h3>
