...
export default function Footer() {
  return (
    <footer className="footer footer-center bg-primary text-base-content main__layout" style={{ paddingTop: '2rem', paddingBottom: '2rem', rowGap: 0, gap: '1rem' }}>
      <div className='grid md:grid-cols-3 justify-items-center items-start md:mb-10'>
        ...
        <div className='md:border-l-2'>
          <h3 className='font-bold text-2xl text-gray-500 md:hidden'>Our Location</h3>
          <ul className='flex flex-col gap-4 md:pl-8 md:h-40'>
            <li key={ shortid.generate() }>
              <Link href="/" className='flex flex-col justify-center items-center md:items-start'>
                ...
                <p className='text-primary-content md:text-left'>17/12 Kluai Mai Alley, Chorakhe Bua, Lat Phrao, Bangkok 10230</p>
              </Link>
            </li>
            <li key={ shortid.generate() }>
        ...
        <div className='md:border-l-2 md:h-40'>
          <h3 className='font-bold text-2xl text-gray-500 md:hidden'>Get in Touch</h3>
