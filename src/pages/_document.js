...
export default function Document() {
  return (
    <Html lang="en">
      <Head>
        <meta property="og:description" content="Explore an enchanting realm of locally-grown cannabis delights at Ganjana store. Indulge in exquisite, community-supported products sourced from our finest local farmers." key="description" />
