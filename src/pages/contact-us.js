  ...
  return (
    <div className="pb-8">
      ...
      <div className="main__layout">
        ...
        <div className=''>
          <h3 className="font-bold text-primary text-xl">Hours</h3>
          <div>
            <p className="text-primary">Tue - Sun | 1pm -  9pm</p>
          </div>
